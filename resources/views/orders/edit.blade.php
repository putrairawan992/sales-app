...
<div class="container">
    ...
    <form method="POST" action="{{ route('orders.update', $order) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="code" name="code" value="{{ $order->code }}" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="subtotal" name="subtotal" value="{{ $order->subtotal }}" required>
        </div>
        <div class="mb-3">
            <label for="discount" class="form-label">Discount</label>
            <input type="number" step="0.01" class="form-control" id="discount" name="discount" value="{{ $order->discount }}" required>
        </div>
        <div class="mb-3">
